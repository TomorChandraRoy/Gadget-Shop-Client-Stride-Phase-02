    ...
    return (
        <div>
            <div className="flex justify-center items-center ">
                <div className="shadow flex justify-end items-center ">
                    <div
                        onClick={() => setOpen(!open)}
                        className={`relative border-b-4 border-transparent  ${open ? "border-indigo-700 transform transition duration-300" : ""
                            }`}
                    >
                                ...
                                <ul className="space-y-3 dark:text-white">
                                    ...
                                    <li className="font-medium">
                                        ...
                                        <div onClick={handleSignout}
                                            className="flex items-center transform transition-colors cursor-pointer duration-200 border-r-4 border-transparent hover:border-red-600"
                                        >
